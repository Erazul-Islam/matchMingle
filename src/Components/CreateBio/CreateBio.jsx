                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 lg:justify-between">
                    <div>
                        <div>
                            ...
                            <input className="lg:w-96 mt-2 h-10 rounded bg-[#fff]" required placeholder="Name" name="bio" type="text" />
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input className="lg:w-96 mt-2 h-10 rounded bg-[#fff]" required placeholder="male/female" name="type" type="text" />
                        </div>
                    </div>
                    <div>
                        <div>
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <input className="lg:w-96 mt-2 h-10 rounded bg-[#fff]" required placeholder="Ocuupation" name="occupation" type="text" />
                        </div>
                        <div>
                    ...
                    <div>
                        <div>
                            ...
                            <input className="lg:w-96 mt-2 h-10 rounded bg-[#fff]" required placeholder="Fathers name" name="fname" type="text" />
                        </div>
                        <div>
                            <span className="">Mothers name</span><br />
                            <input className="lg:w-96 mt-2 h-10 rounded bg-[#fff]" required placeholder="Mothers name" name="mname" type="text" />
                        </div>
                        <div>
                            <span className="">Permanent Division</span><br />
                            <input className="lg:w-96 mt-2 h-10 rounded bg-[#fff]" required placeholder="permanent division" name="perdiv" type="text" />
                        </div>
                    </div>
                    <div>
                        <div>
                            <span className="">Present Division</span><br />
                            <input className="lg:w-96 mt-2 h-10 rounded bg-[#fff]" required placeholder="Present division" name="prediv" type="text" />
                        </div>
                        <div>
                            <span className="">Expected partner age</span><br />
                            <input className="lg:w-96 mt-2 h-10 rounded bg-[#fff]" required placeholder="Expected" name="exage" type="text" />
                        </div>
                        <div>
                            <span className="">Expected partner height</span><br />
                            <input className="lg:w-96 mt-2 h-10 rounded bg-[#fff]" required placeholder="height" name="exheight" type="text" />
                        </div>
                    </div>
                    <div>
                        <div>
                            <span className="">Expected partner weight</span><br />
                            <input className="lg:w-96 mt-2 h-10 rounded bg-[#fff]" required placeholder="Present division" name="exweight" type="text" />
                        </div>
                        <div>
                            <span className="">Mobile Number</span><br />
                            <input className="lg:w-96 mt-2 h-10 rounded bg-[#fff]" required placeholder="Expected" name="mobile" type="text" />
                        </div>
                    </div>
                </div>
